...
module.exports = {
  ...
  onStart: async function ({ api, event }) {
      try {
        ...
        const ownerInfo = {
          name: '🔖 𝑮𝒓𝒐𝒖𝒅𝒆 𝑱𝒖𝒏𝒊𝒐𝒓 𝔼𝕝 𝕋𝕠𝕞𝕠𝕦𝕣𝕒 🏷',
          gender: 'Boy',
          hobby: '𝙋𝙇𝘼𝙔 🏀𝘽𝘼𝙎𝙆𝙀𝙏𝘽𝘼𝙇𝙇🏀 with my best friends CHRIST 🇺🇸 ',
          relationship: '𝙈𝘼𝙍𝙍𝙄𝙀𝘿 with 𝐌𝐲 𝐛𝐚𝐛𝐲 𝐒𝐚𝐫𝐚𝐡  i love this girl 🥺',
          facebookLink: 'https://www.facebook.com/profil.php?id=61554865965784 ',
